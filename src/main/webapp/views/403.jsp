...
<head>
    ...
    <title>403 Forbidden | Electricity Bill Management</title>
</head>
...
<body class="body-without-aside">
	...
	<main class="container" style="padding-top:10rem;">
        <h2>403 Forbidden</h2>
        <p>
            You're Forbidden from trying to access that resource.
        </p>
        <% String userType = String.valueOf(session.getAttribute("userType")); %>
        <% if (userType.equals("user")) { %>
	        <a href="${pageContext.request.contextPath}/home" role="button" class="back-btn outline secondary">
	            Go back to My Home Page
	        </a>
        <% } else if (userType.equals("admin")) { %>
	        <a href="${pageContext.request.contextPath}/admin-home" role="button" class="back-btn outline secondary">
	            Go back to My Home Page
	        </a>
        <% } else { %>
